  ...
  return (
    <>
      <div className="bg-secondary">
        <div className="flex justify-between pt-24 px-20 ">
        ...
        <div className="flex justify-between mt-24 px-20">
          ...
          <div className="w-6/12 ">
            ...
            <BenefitCard
              ...
              description="Lihat live demo project yang akan kamu buat di akhir buku ini."
              icon="/live-demo.svg"
              className="mt-5"
            />
            <BenefitCard
              title="Dukungan Komunitas"
              description="Sebuah server Discord berisi teman-teman yang akan membantu kamu."
              icon="/chat.svg"
              className="mt-5"
            />
          </div>
